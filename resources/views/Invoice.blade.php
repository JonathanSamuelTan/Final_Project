    ...
    <nav class="navbar" style="background-color: #263159;">
        <div class="container-fluid">
          <div class="row justify-content-center align-items-center w-100">
            ...
            <h1 class="text-white text-center mx-auto">Add Product</h1>
          </div>
        </div>
    </nav>
    
    <form id="product-form" action="{{route('AddProduct')}}" method="POST" enctype="multipart/form-data">
      @csrf
      <div class="form-group">
        <label for="product-name">Product Name</label>
        <input type="text" id="product-name" name="ProductName" minlength="8" maxlength="80" required >
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="file" id="product-image" name="ProductIMG" accept="image/*" required>
      </div>
